namespace SplasherStudio {
	partial class Studio {
		...
		private void InitializeComponent() {
			...
			this.tasText = new SplasherStudio.Controls.RichText();
			...
			this.tasText.Language = SplasherStudio.Controls.Language.TAS;
			...
			this.tasText.TextChanged += new System.EventHandler<SplasherStudio.Controls.TextChangedEventArgs>(this.tasText_TextChanged);
